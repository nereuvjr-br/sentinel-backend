"""
Migração: Adicionar coluna 'processed_at' à tabela sentinel_processed_files
Data: 2025-12-26
"""
...
async def migrate():
    ...
    async with engine.begin() as conn:
        print("🔧 Verificando se a coluna 'processed_at' existe...")
        ...
        if exists:
            print("✅ Coluna 'processed_at' já existe!")
        else:
            ...
            print("✅ Coluna 'processed_at' adicionada com sucesso!")
